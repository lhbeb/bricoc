        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://ko-fi.com https://*.ko-fi.com https://js.stripe.com https://chatapppay-rust.vercel.app http://code.tidio.co https://code.tidio.co http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com https://analyticsapp-five.vercel.app https://cokaro-mailproject.vercel.app https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com https://www.17track.net https://connect.facebook.net",
              ...
              "connect-src 'self' https://ko-fi.com https://*.ko-fi.com https://vfuedgrheyncotoxseos.supabase.co https://sappffmylpsmbidysyqh.supabase.co https://*.supabase.co https://api.stripe.com https://*.stripe.com https://hooks.stripe.com https://*.stripe.network https://chatapppay-rust.vercel.app http://*.tidio.co https://*.tidio.co http://*.tidio.com https://*.tidio.com http://*.tidiochat.com https://*.tidiochat.com wss://*.tidio.co wss://*.tidio.com wss://*.tidiochat.com https://analyticsapp-five.vercel.app https://analyticsapp.vercel.app https://cokaro-mailproject.vercel.app https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com https://extcall.17track.net https://www.facebook.com",
