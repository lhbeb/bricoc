          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-8 text-center">
              ...
              <button
                ...
                className="bg-[#233F31] hover:bg-[#1a3025] text-[#FAF6EB] px-6 py-3 rounded-lg font-medium transition-colors duration-200"
              >
                Write a Review
              </button>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="border-b border-gray-200 p-6">
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                {/* Rating Summary */}
                <div>
                  <h2 className="text-2xl font-bold text-[#233F31] mb-1">What Bricoc Customers Say</h2>
                  <p className="text-sm text-gray-600 mb-3">Real feedback on our products, service, and shopping experience.</p>
                  <div className="flex items-center gap-4">
                    <div className="text-4xl font-bold text-[#233F31]">{reviewStats.averageRating.toFixed(1)}</div>
                    <div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star 
                            key={i}
                            className={`h-5 w-5 ${i < Math.floor(reviewStats.averageRating) ? 'text-[#789676] fill-[#789676]' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
                ...
                <div className="flex items-center">
                  <button
                    onClick={() => setShowReviewForm(true)}
                    className="bg-[#233F31] hover:bg-[#1a3025] text-[#FAF6EB] px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
              {displayReviews.map((review, index) => {
                ...
                return (
                  <div key={`${review.id}-${index}`} className="bg-[#FAF6EB]/40 rounded-lg p-5 border border-[#233F31]/10">
                  <div className="flex items-start gap-3 mb-3">
                    <Image 
                    ...
                    <div className="flex-grow min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <div className="min-w-0 flex-1">
                          <h3 className="font-medium text-[#233F31] flex items-center gap-2 flex-wrap">
                            {review.author}
                              {review.verified && (
                              <span className="flex items-center text-[#789676] text-xs whitespace-nowrap font-medium">
                  ...
                  {review.productTitle && review.productSlug && (
                    <div className="mb-2">
                      <span className="text-xs text-[#789676] hover:text-[#233F31] hover:underline cursor-default inline-flex items-center gap-1 font-medium">
                        {review.productTitle}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i}
                          className={`h-3.5 w-3.5 ${i < review.rating ? 'text-[#789676] fill-[#789676]' : 'text-gray-300'}`}
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  {review.title && (
                    <h4 className="font-medium text-[#233F31] mb-2 text-sm">{review.title}</h4>
                  )}
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#233F31] focus:border-transparent resize-none"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#789676] hover:bg-[#789676]/10 transition-colors duration-200">
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                      isSubmitting 
                        ...
                        : 'bg-[#233F31] hover:bg-[#1a3025] text-[#FAF6EB]'
                    }`}
                  >
