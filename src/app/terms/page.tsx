  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold text-[#262626] mb-2">Bricoc Terms of Service</h1>
        <p className="text-gray-600 mb-8">Last Updated: {currentDate}</p>
        
        <div className="prose max-w-none text-gray-700 space-y-8">
          <p className="text-lg leading-relaxed">
            Welcome to Bricoc. By accessing or using our website, marketplace, or services, you agree to be bound by these Terms of Service. Please read them carefully. If you do not agree, please discontinue using the site.
          </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Bricoc operates as a direct retailer and as a curated marketplace.</li>
              ...
              <li>All purchases made through Bricoc are processed under these Terms.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Bricoc hosts a controlled marketplace where approved private sellers may offer products.
            </p>
            ...
            <p className="mb-4">
              Bricoc reserves the right to reject, refund, or cancel any order if the item fails inspection.
            </p>

            <h3 className="text-xl font-bold text-[#262626] mt-6 mb-3">3.3 Seller Responsibility</h3>
            <p className="mb-2">Sellers on the Bricoc platform are responsible for:</p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
            ...
            <p>
              Bricoc is not responsible for inaccurate representations made by sellers, although we take all reasonable steps to verify product condition before shipment.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              By using our website, you acknowledge that Bricoc sources products through:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <div>
            ...
            <p className="mt-4">
              Bricoc is not responsible for delays caused by carriers or incorrect shipping information provided by the customer.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Bricoc is not liable for indirect, incidental, punitive, or consequential damages arising from your use of our services, products, or platform.
            </p>
            <p>
          ...
          <div>
            ...
            <p className="mb-4">
              Bricoc monitors orders for unusual activity to protect customers and sellers.
            </p>
            <p className="mb-4">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-3">
              ...
              <div>
                ...
                <div className="text-gray-600">contact@bricoc.com</div>
              </div>
              <div>
